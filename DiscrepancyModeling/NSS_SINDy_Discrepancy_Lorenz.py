...
x=odeint(LorenzDiscrepancy,x0,t,args=(p0,),rtol = 1e-12, atol = 1e-12)
dx=np.transpose(LorenzDiscrepancy(np.transpose(x), 0, p0))
...
pp4.grid(False)
pp4.axis('off')
#plt.savefig("Lorenz_NoiseLevel_"+str(NoisePercentage)+".pdf")
...
Xi0[0,0]=-9.5;Xi0[1,0]=10.5;
Xi0[0,1]=27.6;Xi0[1,1]=-1.1;Xi0[5,1]=-0.9;
Xi0[2,2]=-2.6;Xi0[4,2]=1.05;
...
for k in range(Nloop):
    ...
    # Add constraint
    index_min[0,0]=True;index_min[1,0]=True;
    index_min[0,1]=True;index_min[1,1]=True;index_min[5,1]=True;
    index_min[2,2]=True;index_min[4,2]=True;
...
plt.figure(figsize=(30,25))
pp4=plt.axes(projection='3d')
pp4.plot3D(x[q:-q,0], x[q:-q,1], x[q:-q,2], color='black',linewidth=8)
pp4.plot3D((xn-NoiseID)[q:-q,0], (xn-NoiseID)[q:-q,1], (xn-NoiseID)[q:-q,2], color='orange',linestyle='--',linewidth=8)
pp4.view_init(0, -30)
pp4.grid(False)
pp4.axis('off')
