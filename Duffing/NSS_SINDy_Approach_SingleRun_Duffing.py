# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 22:21:00 2020
...
plt.grid(False)
plt.axis('off')
#plt.savefig("Duffing_NoiseLevel"+str(NoisePercentage)+".pdf")
...
plt.grid(False)
plt.axis('off')
#plt.savefig("Duffing_NoiseLevel_Denoised"+str(NoisePercentage)+".pdf")
